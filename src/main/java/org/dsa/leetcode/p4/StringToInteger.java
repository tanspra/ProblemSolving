...
*  public int myAtoi(String s) {
        ...
        if (charArray[0] == '+') {
            result = convertInNo(charArray, 1,false);
        } else if (charArray[0] == '-') {
            result = convertInNo(charArray, 1,true);
        } else {
            result = convertInNo(charArray, 0,false);
        }
    ...
    private int convertInNo(char[] charArray, int index,boolean isNegative) {
        int result = 0;
        for (int i = index; i < charArray.length; i++) {
            if (charArray[i] < 48 || charArray[i] > 57) {
                ...
                }else if(newResult!=0 && newResult > result){
                    return Integer.MIN_VALUE;
                }
                else {
                    if(isNegative){
